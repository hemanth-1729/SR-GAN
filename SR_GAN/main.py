...
parser.add_argument('--image_dir',default="/Users/kongarahemanth/Documents/Academics/Advanced Deep Learning/Project 2/Trail_simul_800/image_dir",type=str, help='Path to high resolution image directory.')
