...
class FastSRGAN(object):
    ...
    def build_discriminator(self):
        """Build the Discriminator similar to generator."""
        ...
        # Pre-residual block
        c1 = keras.layers.Conv2D(self.gf, kernel_size=3, strides=1, padding='same')(img_hr)
        c1 = keras.layers.BatchNormalization()(c1)
        c1 = keras.layers.PReLU(shared_axes=[1, 2])(c1)
        ...
        validity = keras.layers.Conv2D(1, kernel_size=1, strides=1, activation='sigmoid', padding='same')(c2)

        return keras.models.Model(img_hr, validity)
